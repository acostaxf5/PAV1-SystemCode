...
namespace SYSTEMCODE.Capa_de_Vista.Informes.Listados
{
    public partial class FrmFactura : Form
    {
        ...
        public FrmFactura(string idFactura, IList<string> parametrosRecibidos)
        {
        ...
        {
            ReportDataSource reporte = new ReportDataSource("Factura", FacturaDetalle.ObtenerDetalleFactura(idFactura));
            ...
            this.rvListado.LocalReport.ReportEmbeddedResource = "SYSTEMCODE.Capa_de_Vista.Informes.Reportes.Factura.rdlc";
